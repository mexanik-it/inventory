...
std::string
    ...
    sn_hdd        = "unknown",      // сер.номера жестких дисков
    sn_mem        = "unknown";      // сер.номера модулей памяти
